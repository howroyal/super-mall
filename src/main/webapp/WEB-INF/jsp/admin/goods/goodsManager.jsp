...
<body>
		...
		<div class="modal fade" id="deleteModal" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<input type="hidden" id="removePkid" /> 该操作暂时不可恢复,确认删除此banner吗?
					</div>
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" role="form" id='editForm'>
							...
							<div class="form-group">
								<label for="editBannerName" class="col-sm-2 control-label">名称<font
									color="red">*</font>:
								</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="editBannerName"
										name="bannerName" maxlength="30" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="inputFile" class="col-sm-2 control-label">图片选择<font
									color="red">*</font>:
								</label>
								<div class="col-sm-4">
									<div class="container-fluid">
								...
								<div class="input-group-btn">
									<div class="btn btn-primary btn-file">
										<i class="glyphicon glyphicon-folder-open"></i>&ensp;选择 <input
											type="file" data-min-file-count="1" name="editBannerPic"
											id="editBannerPic" class="file">
									</div>
								</div>
							</div>
						</form>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/goodsManager.js"></script>
</body>
</html>
