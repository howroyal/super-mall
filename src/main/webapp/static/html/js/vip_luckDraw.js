...
$(function(){
	...
	$('.btn_start').click(function (){
		...
		switch (item) {
			case 0:
				var _temp = '<h3>很遗憾，没能中奖</h3><img src="img/noWinning.png" alt=""/><p>友情提示：这次没中不要紧，下次可先沐浴更衣斋戒三日后择良辰吉时端正坐姿后再试~~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
			...
			case 1:
				...
				break;
			case 2:
				var _temp = '<h3>恭喜您~抽中了88积分</h3><img src="img/award/award_2.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
				rotateFn(2, 54, _temp);
				break;
			case 3:
				var _temp = '<h3>恭喜您~抽中了电动剃须刀礼盒</h3><img src="img/award/award_3.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
				rotateFn(3, 90, _temp);
				break;
			case 4:
				var _temp = '<h3>恭喜您~抽中了8积分</h3><img src="img/award/award_4.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
			...
			case 5:
				...
				break;
			case 6:
				var _temp = '<h3>恭喜您~抽中了28积分</h3><img src="img/award/award_6.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
				rotateFn(6, 198, _temp);
				break;
			case 7:
				var _temp = '<h3>恭喜您~抽中了象印保温杯</h3><img src="img/award/award_7.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
				rotateFn(7, 234, _temp);
				break;
			case 8:
				var _temp = '<h3>恭喜您~抽中了18积分</h3><img src="img/award/award_8.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
				rotateFn(8, 270, _temp);
				break;
			case 9:
				var _temp = '<h3>恭喜您~抽中了超大防风双人伞</h3><img src="img/award/award_9.jpg" alt=""/><p>中奖信息已记录，工作人员会在2个工作日内联系您，请耐心等待~</p><a href="javascript:void(0)" class="btns btn_next">再抽一次</a>';
